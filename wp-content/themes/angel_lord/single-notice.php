...
/**
 * The template for displaying all Notice posts
 *
				...
				<div class="details-wrapper">
					...
					<div class="details-meta">
						<div class="single-meta">
							<p><i class="fas fa-calendar-alt"></i> <?php echo get_the_date(); ?></p>
						</div>
					</div>
								...
								?>
									<div class="single-latest">
										<div class="latest-image">
											<a href="<?php the_permalink(); ?>"><img class="img-fluid" src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'event-single'); ?>" alt="<?php echo get_the_title(); ?>"></a>
										</div>
