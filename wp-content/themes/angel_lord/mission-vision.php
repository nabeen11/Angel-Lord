            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-hrader text-white text-center">
                        <h1 class="display-3">Mission & Vision</h1>
                        <div class="page-breadcrumb">
                            <p><a class="text-white" href="<?php echo get_site_url(); ?>">Home</a> - Mission Vision</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="services-section section-ptb">
    <div class="services-area">
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-xs-5" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="col-md-6 mb-xs-5" data-aos="fade-up" data-aos-delay="400">
                    <div class="single-service-3 active text-center text-white py-5 px-4">
                        <div class="service-text" style="padding-bottom: 55px;">
                            <h4>Our Vision</h4>
